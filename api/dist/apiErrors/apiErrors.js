...
exports.DoesNotExist = exports.AlreadyExistError = exports.BadRequestError = exports.UnauthorizedError = exports.InternalServerError = exports.ForbiddenError = exports.NotFoundError = void 0;
...
class AlreadyExistError extends ApiError {
    constructor(message = 'Already Exists', source) {
...
class DoesNotExist extends ApiError {
    constructor(message = 'Does not Exist', source) {
        super(409, message, source);
        this.message = message;
    }
}
